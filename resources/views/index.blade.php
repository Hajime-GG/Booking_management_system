...
<body>
            ...
            <div class="container-fluid ">
                ...
                <div class="collapse navbar-collapse " id="navbar1">
                    <div class="navbar-nav mx-auto text-black">
                       ...
                       <a href="{{url('/login')}}" class="nav-item nav-link active "> 
                       <button type="button" class="btn btn-outline-dark p-2">Login/Signup                 
                        </button>
                        </a>
                    </div>
                </div>
    ...
    <main class="m-5 py-3">
        <section class="container m-4 py-3" id="about-us">
        ...
        <section id="team" class="container m-4 py-3">
        ...
        <section id="contact" class="container m-4 py-3">
            ...
            <div class="row py-3">
                <div class="col-md-6">
                    <div class="container p-3">
                        ...
                        <div class="text-black-50 text-center fs-5">+91 00000 00000</div>
                        <div class="text-black-s text-center fs-4">Our Address</div>
                        <div class="text-black-50 text-center fs-5">Example Address <br> Example Address</div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="container">
                                ...
                                <div class="card-body">
                                    <form>
                                        ...
                                        <div class="form-group text-center p-3">                                               
                                            <input type="submit" class="btn btn-outline-dark p-2" value="Send Message">
                                        </div>
                                    </form>
                                </div>
                            </div>
